...
\Delta \overline{ \ln S^e_{ijet}}&=&\frac{\sigma_j}{\sigma_j-1} \left(\sum_k \theta_{ke}\overline{S_{kejt}} \Delta \ln A_{kjt}-\Delta \ln A_{ijt}\right) \\
...
\bitem
	...
	\beqns
		X_e&=&\begin{pmatrix}	X_{e11} & \boldsymbol{0} & \dots &  0 \\
			 \boldsymbol{0} & X_{e12} & \dots& 0 \\
		 	\vdots \\
			 \boldsymbol{0} & \boldsymbol{0}& \dots & X_{eJT} \\
		\end{pmatrix}
	\eeqns
