...
\Delta \overline{ \ln S^e_{ijet}}&=&\sum_k \theta_{ke}\overline{S_{kejt}} \pi_{kjt}-\pi_{ijt} \\
1&=&\sum_k\theta_k^e\overline{S_{kejt}}  \label{eq:total_sum} \\
\Delta  \left[\ln \frac{q_{eJt}}{q_{e'Jt}}\right]&=&\beta_j\left[\sum_k\left(\theta_k^e \overline{S_{kJet}}-\theta_k^{e'} \overline{S_{kJe' t}}\right)\pi_{kjt}\right]+\gamma_{e,e't} \label{eq:employment_eq} 
\eeqn
