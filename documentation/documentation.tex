...
\beqn
\Delta \overline{ \ln S^e_{iJe}}&=&\frac{\sigma_J}{\sigma_J-1} \left(\sum_k \theta_k^e\overline{S_{keJ}} \Delta \ln A_{kJ}-\Delta \ln A_{iJ}\right)\\
\Delta \overline{\ln S^e_{iJe}}-\Delta \overline{\ln S^e_{\text{abstract},eJ}}&=&-\frac{\sigma}{\sigma-1}\Delta \ln A_{iJ}
\eeqn
were we imposed that $(\Delta\ln A_{abstract,J})_t=0$ . This gives us our estimating equations:
\beqn
\Delta \overline{ \ln S^e_{iJe}}&=&\frac{\sigma_J}{\sigma_J-1} \left(\sum_k \theta_k^e\overline{S_{keJ}} \Delta \ln A_{kJ}-\Delta \ln A_{iJ}\right)+\varepsilon_{iJe}\\
\Delta \overline{\ln S^e_{iJe}}-\Delta \overline{\ln S^e_{\text{abstract}eJ}}&=&-\frac{\sigma_J}{\sigma_J-1}\Delta \ln A_{iJ} + \nu_{iJe}\\
\Delta  \left[\ln \frac{q_e(J)}{q_{e^\prime}(J)}\right]&=&\sum_k\left(\theta_k^e \overline{S_{kJe}}-\theta_k^{e^\prime} \overline{S_{kJe^\prime}}\right)\Delta \ln A_k+const_{e,e^\prime}+\eta_{e,e'}
\eeqn
