...
\benu
	...
	\item I reorder $\Lambda$ by skill, as follows:
	\beqns
		...
		\end{pmatrix}
	\eeqns
	indexes loop over year, job and education. The reordered $\Lambda$ is given by:
	\beqns
	...
	\beqns
		...
		\end{pmatrix}
	\eeqns
	this vector of is has the same dimensions as $\Lambda^r$. It places all elements of $\Sigma$ in the ``right'' order \red{I should say what the right order is here}.
	...
	\beqns
		y_1=Z_1\times (\Lambda^r\odot \tilde{\Sigma})
	\eeqns
