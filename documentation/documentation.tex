...
\beqns
\hat{\mu}=\arg\min_c\left(\frac{1}{N}\varepsilon(w_i,c)'Z\right)A\left(\frac{1}{N}Z'\varepsilon(w_i,c)\right)
\eeqns
...
\bitem 
	...
	\beqns
	\hat{V}=\frac{1}{{N}}\sum_{i=1}^N\psi(w_i,\hat{\mu})\psi(w_i,\hat{\mu})'
	\eeqns
