...
\Delta \overline{ \ln S^e_{ijet}}&=&\frac{\sigma_j}{\sigma_j-1} \left(\sum_k \theta_{ke}\overline{S_{kejt}} \Delta \ln A_{kjt}-\Delta \ln A_{ijt}\right)+\varepsilon_{iej} \\
...
%	\eeqn
	...
	\beqn
		\min_{\theta} \frac{1}{N}\left(u'Z'(Z'Z)^{-1}Zu\right)
	\eeqn
\eitem 
