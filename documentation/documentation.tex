...
\subsection{Benjamini-Hotchberg}

\beqns
	t_{stat}&=&\frac{p_{2017}-p_{2001}}{\sqrt{s_p^2/n_{2017}+s_p^2/n_{2001}}}\\
			s_p^2&=&\frac{(n_{2017}-1)p_{2017}(1-p_{2017})+(n_{2001}-1)p_{2001}(1-p_{2001})}{n_{2017}+n_{2001}-2}
\eeqns
\bitem
	\item Order p-values from lowest to highest.
	\item Reject if $p_k<\alpha\frac{k}{m}$
\eitem 
