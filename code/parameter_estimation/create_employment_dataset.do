    ...
    *In this chunk of code I create the variables I need for panel data operations.
    {
        ...
        gcollapse (sum) people (count) obs=people, by(`occupation'  year `definition')
    ...
    *Computing changes in employment shares and total emploument
    {
        ...
        keep bsoc00Agg ref_year ref_job_type0 d_l_educ_empshare d_l_employment weight obs
    ...
    *In this code I apply the final filter to the LFS
    {
...

        {
            ...
            drop d_l_educ_empshare

            drop obs

            save "data/additional_processing/regression_employment_dataset.dta", replace
        }
    }
