function [z_matrix,y_matrix,s_matrix,n_total_parameters,size_vector, ...
    e1_dlna_index,e1_educ_index,e1_code,lower_bound, upper_bound]=extract_data_matrices_norest(data)
    ...
    z_matrix=get_z_matrix_norest(data);
    
    %s is the matrix I use for multiplying with the parameters
    s_matrix=get_s_matrix_norest(data);
