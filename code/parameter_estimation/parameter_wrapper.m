...
[y_matrix,ones_matrix,e2s_matrix,n_total_parameters,size_vector,e1_dln_a_index, e1_theta_code, ...
...
error_solve=@(p)get_quadratic_form(p,y_matrix,ones_matrix,e2s_matrix,size_vector,e1_dln_a_index,e1_theta_code,e1_occ_index);
