...
pdfName <- paste("output/densitySep","TimeAgeOldScatterOr.pdf",sep="")
...
pdfName <- paste("output/densitySep","TimeAgeOldScatterDum.pdf",sep="")
ggsave(pdfName,heatmap,dpi = 700,width=10,height=height)
...
pdfName <- paste("output/densitySep","TimeAgeOldScatterCont.pdf",sep="")
ggsave(pdfName,heatmap,dpi = 700,width=10,height=height)
...
pdfName <- paste("output/densitySep","TimeAgeOldScatterMod.pdf",sep="")
ggsave(pdfName,heatmap,dpi = 700,width=10,height=height)
