function [i_matrix,n_indexes]=create_index_matrix(data,skill_indexes,scale_solution,education_vector)
    ...
    [...
        %alpha_D, alpha_restr,
        dummy_matrix, scale_restr,scale_matrix,~,n_scale,~]=create_problem_matrices(data_r, n_alphas);  %skill_indexes,n_alphas);

    %Recovering the matrix of indexes
    r_matrix=rescaled_matrix(dummy_matrix, ...
        ... %alpha_D,alpha_restr,
        scale_solution,n_scale,scale_restr,scale_matrix,skill_indexes);
